...
#
# Generated by export_simulation on Thu Jul 23 15:55:31 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Rom_Triangle.sh' script.

./Rom_Triangle.sh -reset_run
...
./Rom_Triangle.sh -noclean_files

For more information on the script, please type './Rom_Triangle.sh -help'.
