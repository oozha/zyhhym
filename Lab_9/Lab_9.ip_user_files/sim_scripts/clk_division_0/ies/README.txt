...
#
# Generated by export_simulation on Thu Jul 23 14:19:19 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './clk_division_0.sh' script.

./clk_division_0.sh -reset_run
...
./clk_division_0.sh -noclean_files

For more information on the script, please type './clk_division_0.sh -help'.
