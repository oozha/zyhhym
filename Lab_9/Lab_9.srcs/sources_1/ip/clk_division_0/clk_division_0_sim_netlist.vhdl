...
-- Date        : Thu Jul 23 14:20:00 2020
-- Host        : LAPTOP-URFJDTFC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/zyhwork/Lab_9/Lab_9.srcs/sources_1/ip/clk_division_0/clk_division_0_sim_netlist.vhdl
...
architecture STRUCTURE of clk_division_0_clk_division is
  ...
  signal \flag1_carry_i_1__0_n_0\ : STD_LOGIC;
  signal \flag1_carry_i_1__1_n_0\ : STD_LOGIC;
  signal flag1_carry_i_1_n_0 : STD_LOGIC;
  signal \flag1_carry_i_2__0_n_0\ : STD_LOGIC;
  signal \flag1_carry_i_2__1_n_0\ : STD_LOGIC;
  signal flag1_carry_i_2_n_0 : STD_LOGIC;
  signal \flag1_carry_i_3__0_n_0\ : STD_LOGIC;
  signal \flag1_carry_i_3__1_n_0\ : STD_LOGIC;
  signal flag1_carry_i_3_n_0 : STD_LOGIC;
  signal \flag1_carry_i_4__0_n_0\ : STD_LOGIC;
...
\flag1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \flag1_carry_i_1__0_n_0\,
      S(2) => \flag1_carry_i_2__0_n_0\,
      S(1) => \flag1_carry_i_3__0_n_0\,
      S(0) => \flag1_carry_i_4__0_n_0\
    );
\flag1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \flag1_carry_i_1__1_n_0\,
      S(1) => \flag1_carry_i_2__1_n_0\,
      S(0) => \flag1_carry_i_3__1_n_0\
    );
...
\flag1_carry_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      I5 => \cnt_reg_n_0_[22]\,
      O => \flag1_carry_i_1__0_n_0\
    );
\flag1_carry_i_1__1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \cnt_reg_n_0_[30]\,
      O => \flag1_carry_i_1__1_n_0\
    );
...
\flag1_carry_i_2__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      I5 => \cnt_reg_n_0_[19]\,
      O => \flag1_carry_i_2__0_n_0\
    );
\flag1_carry_i_2__1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\flag1_carry_i_3__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      I5 => \cnt_reg_n_0_[16]\,
      O => \flag1_carry_i_3__0_n_0\
    );
\flag1_carry_i_3__1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\flag1_carry_i_4__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
entity clk_division_0 is
  ...
  attribute X_CORE_INFO of clk_division_0 : entity is "clk_division,Vivado 2018.3";
end clk_division_0;
...
architecture STRUCTURE of clk_division_0 is
  ...
  attribute X_INTERFACE_PARAMETER of i_clk : signal is "XIL_INTERFACENAME i_clk, ASSOCIATED_RESET i_rst, FREQ_HZ 100000000, PHASE 0.000, INSERT_VIP 0";
